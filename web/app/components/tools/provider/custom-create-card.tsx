  ...
  return (
    <>
      {isCurrentWorkspaceManager && (
        <div className='flex flex-col col-span-1 overflow-hidden bg-gray-200 border-[0.5px] border-black/5 rounded-xl min-h-[160px] transition-all duration-200 ease-in-out cursor-pointer hover:bg-gray-50 hover:shadow-lg'>
