const translation = {
  ...
  welcome: 'Bienvenido a Agent Studio, por favor inicia sesión para continuar.',
  ...
  license: {
    tip: 'Antes de comenzar con Agent Studio Community Edition, lee la',
    link: 'Licencia de código abierto de GitHub',
  },
  join: 'Unirse',
  joinTipStart: 'Te invita a unirte al equipo de',
  joinTipEnd: 'en Agent Studio',
  invalid: 'El enlace ha expirado',
  explore: 'Explorar Agent Studio',
