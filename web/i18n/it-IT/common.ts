const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Account Agent Studio',
    langGeniusAccountTip: 'Il tuo account Agent Studio e i dati utente associati.',
  ...
  members: {
    ...
    invitationSentTip:
      'Invito inviato, e possono accedere a Agent Studio per accedere ai dati del tuo team.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Il servizio di hosting OpenAI fornito da Agent Studio ti consente di utilizzare modelli come GPT-3.5. Prima che la tua quota di prova sia esaurita, devi configurare altri fornitori di modelli.',
  ...
  apiBasedExtension: {
    title:
      'Le estensioni API forniscono una gestione centralizzata delle API, semplificando la configurazione per un facile utilizzo nelle applicazioni di Agent Studio.',
  ...
  about: {
    ...
    nowAvailable: 'Agent Studio {{version}} è ora disponibile.',
    latestAvailable: 'Agent Studio {{version}} è l\'ultima versione disponibile.',
  },
  appMenus: {
