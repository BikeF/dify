const translation = {
  ...
  welcome: 'Ласкаво просимо до Agent Studio, будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Agent Studio Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Agent Studio',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Agent Studio',
