const translation = {
  ...
  welcome: 'Добро пожаловать в Kofe, пожалуйста, войдите, чтобы продолжить.',
  ...
  license: {
    tip: 'Перед запуском Kofe Community Edition ознакомьтесь с лицензией GitHub',
    link: 'Лицензия с открытым исходным кодом',
  },
  join: 'Присоединиться',
  joinTipStart: 'Приглашаем вас присоединиться к',
  joinTipEnd: 'команде на Kofe',
  invalid: 'Ссылка истекла',
  explore: 'Изучить Kofe',
