const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Agent Studio account',
    langGeniusAccountTip: 'Your Agent Studio account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Agent Studio to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Agent Studio allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Agent Studio\'s applications.',
    link: 'Learn how to develop your own API Extension.',
    linkUrl: 'https://docs.kofe.ai/features/extension/api_based_extension',
  ...
  about: {
    ...
    nowAvailable: 'Agent Studio {{version}} is now available.',
    latestAvailable: 'Agent Studio {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
  ...
  imageUploader: {
    ...
    uploadFromComputerLimit: 'Upload files cannot exceed {{size}} MB',
    pasteImageLink: 'Paste file link',
    pasteImageLinkInputPlaceholder: 'Paste file link here',
    pasteImageLinkInvalid: 'Invalid file link',
