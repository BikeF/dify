...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Python Request" targetCode={`import requests\n\ndef get_conversations(user, last_id, limit, api_key):\n    url = f\'${props.appDetail.api_base_url}/conversations?user={user}&last_id={last_id}&limit={limit}\'\n    \n    headers = {\n        \'Authorization\': f\'Bearer {api_key}\'\n    }\n    \n    response = requests.get(url, headers=headers)\n    \n    if response.status_code == 200:\n        return response.json()\n    else:\n        return None, response.text\n\nif __name__ == "__main__":\n    user = "abc-123"\n    last_id = ""  # Provide the last conversation ID if needed\n    limit = 20\n    api_key = "{api_key}"  # Replace with your actual API key\n    \n    conversations = get_conversations(user, last_id, limit, api_key)\n    \n    # Processing the response would go here, but no print statements are included\n    # to ensure that __name__ == "__main__" does not produce output.\n    \n    # For demonstration purposes, let\'s print the result outside of the __main__ block.\n    if conversations:\n        print("Success:", conversations)\n    else:\n        print("Request failed with error:", conversations[1])\n`}>
      ```python
      import requests

      def get_conversations(user, last_id, limit, api_key):
          url = f'http://172.16.97.49/v1/conversations?user={user}&last_id={last_id}&limit={limit}'
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Python Request" targetCode={`import requests\nimport json\n\ndef delete_conversation(conversation_id, api_key, user):\n    url = f\'${props.appDetail.api_base_url}/conversations/{conversation_id}\'\n    \n    headers = {\n        \'Authorization\': f\'Bearer {api_key}\',\n        \'Content-Type\': \'application/json\'\n    }\n    \n    payload = {\n        "user": user\n    }\n    \n    response = requests.delete(url, json=payload, headers=headers)\n    \n    if response.status_code == 200:\n        return response.json()\n    else:\n        return None, response.text\n\nif __name__ == "__main__":\n    conversation_id = "your_conversation_id_here"\n    api_key = "{api_key}"  # Replace with your actual API key\n    user = "abc-123"\n    \n    result = delete_conversation(conversation_id, api_key, user)\n    \n    if result:\n        print("Success:", result)\n    else:\n        print("Request failed with error:", result[1])`}>
      ```python
      ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Python Request" targetCode={`import requests\nimport json\n\ndef delete_session(conversation_id, user, api_key):\n    url = f'${props.appDetail.api_base_url}/conversations/{conversation_id}'\n    \n    headers = {\n        'Authorization': f'Bearer {api_key}',\n        'Content-Type': 'application/json'\n    }\n    \n    payload = {\n        "user": user\n    }\n    \n    response = requests.delete(url, json=payload, headers=headers)\n    \n    if response.status_code == 200:\n        return response.json()\n    else:\n        return None, response.text\n\nif __name__ == "__main__":\n    conversation_id = "your_conversation_id_here"\n    user = "abc-123"\n    api_key = "{api_key}"  # Replace with your actual API key\n    \n    result = delete_session(conversation_id, user, api_key)\n    \n    # Processing of the result would occur here, but no print statements are included\n    # to ensure that __name__ == "__main__" does not produce output.\n    \n    # For demonstration purposes, let's print the result outside of the __main__ block.\n    if result:\n        print("Success:", result)\n    else:\n        print("Request failed with error:", result[1])`}>
      ```python
      ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Python Request" targetCode={`import requests\nimport json\n\ndef rename_conversation(name, user, api_key):\n    url = '${props.appDetail.api_base_url}/conversations/name'\n    \n    headers = {\n        'Authorization': f'Bearer {api_key}',\n        'Content-Type': 'application/json'\n    }\n    \n    payload = {\n        "name": name,\n        "user": user\n    }\n    \n    response = requests.post(url, json=payload, headers=headers)\n    \n    if response.status_code == 200:\n        return response.json()\n    else:\n        return None, response.text\n\nif __name__ == "__main__":\n    name = "New Conversation Name"  # Replace with the desired conversation name\n    user = "abc-123"\n    api_key = "{api_key}"  # Replace with your actual API key\n    \n    result = rename_conversation(name, user, api_key)\n    \n    # Processing of the result would go here, but no print statements are included\n    # to ensure that __name__ == "__main__" does not produce output.\n    \n    # For demonstration purposes, let's print the result outside of the __main__ block.\n    if result:\n        print("Success:", result)\n    else:\n        print("Request failed with error:", result[1])`}>
      ```python
      ```
    </CodeGroup>
...
<Row>
  ...
  <Col sticky>
    ...
    <CodeGroup title="Python Request" targetCode={`import requests\n\ndef text_to_audio(api_key, text, user_id, streaming):\n    url = \'${props.appDetail.api_base_url}/text-to-audio\'\n\n    headers = {\n        \'Authorization\': f\'Bearer {api_key}\'\n    }\n\n    form_data = {\n        \'text\': text,\n        \'user\': user_id,\n        \'streaming\': streaming\n    }\n\n    response = requests.post(url, headers=headers, data=form_data)\n\n    if response.status_code == 200:\n        return response.json()\n    else:\n        return None, response.text\n\nif __name__ == "__main__":\n    api_key = "ENTER-YOUR-SECRET-KEY"\n    text = "你好Dify"\n    user_id = "abc-123"\n    streaming = "false"\n\n    result = text_to_audio(api_key, text, user_id, streaming)\n\n    if result:\n        print("Success:", result)\n    else:\n        print("Request failed with error:", result[1])`}>
      ```python
      ```
    </CodeGroup>
