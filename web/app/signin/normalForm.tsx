  ...
  return (
    <>
      <div className="w-full h-full mx-auto">
        <div className="bg-white h-full shadow-box rounded-[30px] px-[50px] pt-[60px]">
          {!useEmailLogin && (
          ...
          <div className="w-hull text-center block mt-4 text-xs text-gray-600">
            {t("login.tosDesc")}
            &nbsp;
            <span className="text-primary-600">{t("login.tos")}</span>
            &nbsp;&&nbsp;
            <span className="text-primary-600">{t("login.pp")}</span>
          </div>
