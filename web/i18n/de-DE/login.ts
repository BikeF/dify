const translation = {
  ...
  welcome: 'Willkommen bei Agent Studio, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Agent Studio Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Agent Studio beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Agent Studio erkunden',
