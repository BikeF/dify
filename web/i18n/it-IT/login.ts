const translation = {
  ...
  welcome: 'Benvenuto su Agent Studio, per favore accedi per continuare.',
  ...
  license: {
    tip: 'Prima di avviare Agent Studio Community Edition, leggi su GitHub',
    link: 'Licenza open-source',
  },
  join: 'Unisciti',
  joinTipStart: 'Invitato a unirti al',
  joinTipEnd: 'team su Agent Studio',
  invalid: 'Il link è scaduto',
  explore: 'Esplora Agent Studio',
