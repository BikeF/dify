const translation = {
  ...
  welcome: '👋 Welcome to Agent Studio, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Agent Studio Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Agent Studio',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Agent Studio and we will send you a password reset email.',
