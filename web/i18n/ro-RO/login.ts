const translation = {
  ...
  welcome: 'Bine ai venit la Agent Studio, te rugăm să te autentifici pentru a continua.',
  ...
  license: {
    tip: 'Înainte de a începe Agent Studio Community Edition, citește',
    link: 'Licența open-source de pe GitHub',
  },
  join: 'Alătură-te',
  joinTipStart: 'Te invităm să te alături echipei',
  joinTipEnd: 'pe Agent Studio',
  invalid: 'Link-ul a expirat',
  explore: 'Explorează Agent Studio',
