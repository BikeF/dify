const translation = {
  ...
  welcome: 'Bienvenue sur Agent Studio, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Agent Studio Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Agent Studio',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Agent Studio',
