const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Konto Agent Studio',
    langGeniusAccountTip: 'Twoje konto Agent Studio i powiązane dane użytkownika.',
  ...
  members: {
    ...
    invitationSentTip:
      'Zaproszenie zostało wysłane, a oni mogą zalogować się do Agent Studio, aby uzyskać dostęp do danych Twojego zespołu.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Usługa hostowania OpenAI dostarczana przez Agent Studio pozwala korzystać z modeli takich jak GPT-3.5. Przed wyczerpaniem limitu próbnego należy skonfigurować inne dostawców modeli.',
  ...
  apiBasedExtension: {
    title:
      'Rozszerzenia oparte na interfejsie API zapewniają scentralizowane zarządzanie interfejsami API, upraszczając konfigurację dla łatwego użytkowania w aplikacjach Agent Studio.',
  ...
  about: {
    ...
    nowAvailable: 'Agent Studio {{version}} jest teraz dostępny.',
    latestAvailable: 'Agent Studio {{version}} jest najnowszą dostępną wersją.',
  },
  appMenus: {
