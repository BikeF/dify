const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Agent Studio-Konto',
    langGeniusAccountTip: 'Ihr Agent Studio-Konto und zugehörige Benutzerdaten.',
  ...
  members: {
    ...
    invitationSentTip: 'Einladung gesendet, und sie können sich bei Agent Studio anmelden, um auf Ihre Teamdaten zuzugreifen.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'Der OpenAI-Hostingdienst von Agent Studio ermöglicht es Ihnen, Modelle wie GPT-3.5 zu verwenden. Bevor Ihr Probe-Kontingent aufgebraucht ist, müssen Sie andere Modellanbieter einrichten.',
  ...
  apiBasedExtension: {
    title: 'API-Erweiterungen bieten zentralisiertes API-Management und vereinfachen die Konfiguration für eine einfache Verwendung in Agent Studios Anwendungen.',
  ...
  about: {
    ...
    nowAvailable: 'Agent Studio {{version}} ist jetzt verfügbar.',
    latestAvailable: 'Agent Studio {{version}} ist die neueste verfügbare Version.',
  },
  appMenus: {
    overview: 'Übersicht',
